...
// Experimental! Needed for Atari ST to Amiga conversions by the Wanted Team.
// Non-standard period table for double rate frequencies at 0x30.
const uword HippelDecoder::periodsLower[0x40] = {
    0x06b0, 0x0650, 0x05f4, 0x05a0, 0x054c, 0x0500, 0x04b8, 0x0474,
    0x0434, 0x03f8, 0x03c0, 0x038a,
    // +0x0c
    0x0358, 0x0328, 0x02fa, 0x02d0, 0x02a6, 0x0280, 0x025c, 0x023a,
    ...
    0x0087, 0x007f, 0x0078, 0x0071,
    // +0x30
    0x006b, 0x0065, 0x005f, 0x005a, 0x0055, 0x0050, 0x004c, 0x0048,
    0x0044, 0x0040, 0x003c, 0x0039,
    // +0x3c
    0x0036, 0x0033, 0x0030, 0x002d
    // +0x40
};
